		...
		<div className="flex flex-col justify-center items-center min-h-screen">
			...
			>
				<input
					...
					className="border border-gray-400 rounded-md py-2.5 px-2 sm:px-4 focus:outline-gray-200 text-gray-600"
				/>
				<div className="relative">
					<input
						...
						className="border border-gray-400 rounded-md py-2.5 px-2 sm:px-4 focus:outline-gray-200 w-full text-gray-600"
					/>
					<span
				...
				<button
					type="submit"
					className="bg-black cursor-pointer text-white py-2 rounded-md"
				>
					Log In
				</button>
