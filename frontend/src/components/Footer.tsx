...
export const Footer = () => {
    return (
        <div className='space-y-10 py-10 bg-gray-200/10 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>
            ...
            <div className='text-center text-gray-900 text-xs sm:text-xs md:text-sm space-y-5'>
